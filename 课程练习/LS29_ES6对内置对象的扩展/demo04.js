 ...
 * Array.of方法用于将一组值，转换为数组   参数不同，返回结果不同
 * 
 * Array新增的原型方法
...
// Array.from([1, 2, 3], (x) => x * x);// [1, 4, 9]    箭头函数
// 等同于
 ...
 * 取值的长度上，包括start，但不包括end
 */
[1, 2, 3, 4, 5].copyWithin(0, 3);       // [4, 5, 3, 4, 5]    4、5 换 1、2
// 将3号位复制到0号位
...
//fill方法还可以接受第二个和第三个参数，用于指定填充的起始位置和结束位置。 (包含前不包含后)
