//  Part  1111111 数组原型方法（迭代-非破坏性-检测方法）thisValue可以指定callback中的this
...
var returnValue = arr2.every(function (a) {//判断数组元素是否都是偶数，若有不满足的将不再进行后续判断
    console.log(a);//打开此行，查看是否会输出8，为什么？        // 2 5   ; 不会， 5 已经不满足了
    return a%2===0;
});
...
var returnValue = arr2.some(function (a) {//判断数组元素是否都是偶数，若有不满足的将不再进行后续判断
    console.log(a);//打开此行，查看输出了哪些数，为什么？   // 2
    return a%2===0;
});
...
// Part 2222222 数组原型方法（迭代-非破坏性-转换方法）
...
// Part 3333333  数组原型方法（迭代-非破坏性-归约方法）
