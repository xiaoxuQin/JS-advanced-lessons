...
console.log(f,l);   // hello world  键值对里的键相对应，值进行了赋值
let { first, last } = obj1;
console.log(first,last);    // hello world  定义的时候只有属性，没有属性值
...
//foo6 // error: foo6 is not defined
...
var {x5:y5 = 3} = {x5: 5};
console.log(y5);    // 5
console.log(x5);    // ReferenceError: x5 is not defined
