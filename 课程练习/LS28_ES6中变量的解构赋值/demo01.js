/**
 * https://www.cnblogs.com/-simon/p/5941117.html
 */
//不用解构赋值方式定义变量
...
var [foo2] = [];
var [bar2, fee2] = [1];
console.log(foo2, bar2, fee2);  // undefined 1 undefined
...
let [m4 = n4, n4 = 1] = []; // ReferenceError   n4 is not defined
